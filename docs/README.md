...
| Hive Metastore | 🔜 Planned | Table / schema registry | — |
...
Both ports are served by `rustfs-nginx`. No node is a single point of failure for either the data plane or the UI.
